...
public class DeckRepositoryMock: DeckRepositoryProtocol {
    ...
    public lazy var decks: [Deck] = [
        Deck(id: "c3046ed9-83fb-4c81-a83c-b11ae4863bd2", cardsIds: cards.map { $0.id }),

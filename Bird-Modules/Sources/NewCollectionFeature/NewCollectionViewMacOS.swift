//
//  NewCollectionViewMacOS.swift
//  
//
//  Created by Nathalia do Valle Papst on 25/10/22.
//
...
#if os(macOS)
public struct NewCollectionViewMacOS: View {
...
struct NewCollectionViewMacOS_Previews: PreviewProvider {
    static var previews: some View {
        
        HabitatPreview {
            NewCollectionViewMacOS(editingCollection: nil)
